...
# -*- coding:utf-8 -*-
#-------------------------------------------------------------------------------
# Name:        buoy with graph
# Purpose:   定水深ブイの制御パラメータを求める
#            計算完了と同時にグラフを表示させたい
#            現時点では、グラフ表示後に計算を継続するにはグラフを閉じる必要がある。
#
# memo:        you should install NumPy and SciPy and matplotlib.
#              if your PC is Windows, see http://www.lfd.uci.edu/~gohlke/pythonlibs/ .
# Author:      morishita
#
# Created:     01/02/2014
...
def main():
    ...
    times = frange(0.0, 70.0, delta_t)                     # 演算時間のリスト. frange(計算開始時刻[s], 計算集医療時刻[s], 計算時間ステップ[s])
    count = 0
